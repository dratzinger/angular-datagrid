...
export declare interface RevogrFilterPanel
  extends Components.RevogrFilterPanel {}
@ProxyCmp({
  inputs: [
...
export declare interface RevogrOrderEditor
  extends Components.RevogrOrderEditor {}
@ProxyCmp({
...
export declare interface RevogrOverlaySelection
  extends Components.RevogrOverlaySelection {}
@ProxyCmp({
  inputs: [
    "canDrag",
    "colData",
...
export declare interface RevogrScrollVirtual
  extends Components.RevogrScrollVirtual {}
@ProxyCmp({
...
export declare interface RevogrViewportScroll
  extends Components.RevogrViewportScroll {}
@ProxyCmp({
